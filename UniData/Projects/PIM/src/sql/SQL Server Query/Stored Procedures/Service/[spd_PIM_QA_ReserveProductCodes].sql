...
/****** Object:  StoredProcedure [dbo].[spd_ReserveProductCodes]    Script Date: 2016-12-07 1:18:49 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN
		...
		FROM [PIM_QA].[dbo].[ProductCodesReservation]
		WHERE [StatusCode] = 0
	...
	BEGIN
		...
		UPDATE [PIM_QA].[dbo].[ProductCodesReservation]
