...
2. Goto Samples Directory. For example: "cd C:\IBM\UNIDK\UODOTNET\Samples\C#\Connection"

3. Use any editor to edit "Connection.cs" file for correct Hostname, UserID, Password,  Account, ServiceType.

4. To compile the sample program, type the following at the command prompt: 
csc.exe Connection.cs /reference:C:\IBM\UNIDK\UODOTNET\BIN\UODOTNET.DLL
where :
