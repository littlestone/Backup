...
2. Goto Samples Directory. For example: "cd C:\IBM\UNIDK\UODOTNET\Samples\C#\UniDynArray"

3. Use any editor to edit "UniDynArraySample.cs" file for correct Hostname, UserID, Password,  Account, ServiceType.

4. To compile the sample program, type the following at the command prompt: 
csc.exe UniDynArraySample.cs /reference:C:\IBM\UNIDK\UODOTNET\BIN\UODOTNET.DLL
where :
