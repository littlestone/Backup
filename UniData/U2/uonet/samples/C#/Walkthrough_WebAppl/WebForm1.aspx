<%@ Page language="c#" Codebehind="WebForm1.aspx.cs" AutoEventWireup="false" Inherits="Walkthrough_WebAppl.WebForm1" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" text="#0000ff" bgColor="#ffff66">
		<form id="Form1" method="post" runat="server">
			<asp:Label id="Label1" style="Z-INDEX: 101; LEFT: 40px; POSITION: absolute; TOP: 40px" runat="server">Host Name:</asp:Label>
