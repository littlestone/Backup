;;; setup-rgrep.el --- Searching with Grep under Emacs -*- lexical-binding: t; -*-
...
(eval-after-load "wgrep"
  '(define-key wgrep-mode-map (kbd "C-c C-a") 'mc/add-cursors-to-all-matches))

(provide 'setup-rgrep)
;;; setup-rgrep.el ends here
